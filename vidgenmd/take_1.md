# Regen meta-prompt — Take 1 (flowing motion)
...
## Take 1 direction (lowest priority — never override the rules above)

Lean toward **flowing, eye-leading motion**: within the same smooth eased path, let the camera or subject carry a touch more deliberate, continuous movement so the viewer's eye is naturally drawn along the shot and held. Keep it calm and physical — more graceful, not faster or more erratic. This is purely to make the clip a little more visually engaging; abandon it the instant it threatens realism, consistency, or the exact match to the start/end frames.
